...
)  # ignore runtime warnings, like when the window gets forcibly resized by the OS
import sys
import pygame
...
window = pygame.display.set_mode((800, 600))  # (0, 0) sets native resolution
...
player = Player((centered_coordinates[0] + 100, centered_coordinates[1], 20, 20))
del centered_coordinates
player.methods = method.methods

lazers = Rectangles(
    ((200, 0, 10, 150), (255, 0, 0)),
